...
try:
    ...
    LOGGER.error("API_ID env variable is missing")
    exit(1)
try:
    API_HASH = get_config('API_HASH')
except:
    LOGGER.error("API_HASH env variable is missing")
    exit(1)
...
JVBot = Client(name="JVPyroBot", bot_token=BOT_TOKEN, api_id=API_ID, api_hash=API_HASH)
JVBot.start()
